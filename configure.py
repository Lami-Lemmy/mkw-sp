...
asset_in_files = {
    ...
    os.path.join('Scene', 'UI', 'AwardSP.arc.lzma'): [
        ...
        os.path.join('award', 'anim', 'congratulations_fade_in.brlan.json5'),
        os.path.join('award', 'anim', 'congratulations_fade_in_before.brlan.json5'),
        os.path.join('award', 'anim', 'congratulations_fade_out.brlan.json5'),
        ...
        os.path.join('award', 'ctrl', 'AwardItemWin.brctr.json5'),
        os.path.join('award', 'ctrl', 'AwardTeamLose.brctr.json5'),
        os.path.join('award', 'ctrl', 'AwardTeamWin.brctr.json5'),
        os.path.join('award', 'ctrl', 'AwardTypeLose.brctr.json5'),
        os.path.join('award', 'ctrl', 'AwardTypeWin.brctr.json5'),
    ],
    ...
    os.path.join('Scene', 'UI', 'MenuSingleSP.arc.lzma'): [
        ...
        os.path.join('control', 'blyt', 'course_container.brlyt.json5'),
        os.path.join('control', 'ctrl', 'CourseSelectBase.brctr.json5'),
        # Flags
        ...
        os.path.join('control', 'timg', '004.tpl'),
        os.path.join('control', 'timg', '005.tpl'),
        os.path.join('control', 'timg', '006.tpl'),
        os.path.join('control', 'timg', '007.tpl'),
        os.path.join('control', 'timg', '027.tpl'),
        os.path.join('control', 'timg', '029.tpl'),
        os.path.join('control', 'timg', '030.tpl'),
        os.path.join('control', 'timg', '031.tpl'),
        os.path.join('control', 'timg', '032.tpl'),
        os.path.join('control', 'timg', '033.tpl'),
        os.path.join('control', 'timg', '034.tpl'),
        os.path.join('control', 'timg', '035.tpl'),
        os.path.join('control', 'timg', '053.tpl'),
        os.path.join('control', 'timg', '054.tpl'),
        os.path.join('control', 'timg', '055.tpl'),
        os.path.join('control', 'timg', '056.tpl'),
        os.path.join('control', 'timg', '057.tpl'),
        os.path.join('control', 'timg', '058.tpl'),
        os.path.join('control', 'timg', '059.tpl'),
        os.path.join('control', 'timg', '060.tpl'),
        os.path.join('control', 'timg', '061.tpl'),
        os.path.join('control', 'timg', '062.tpl'),
        os.path.join('control', 'timg', '063.tpl'),
        os.path.join('control', 'timg', '064.tpl'),
        os.path.join('control', 'timg', '068.tpl'),
        os.path.join('control', 'timg', '069.tpl'),
        os.path.join('control', 'timg', '070.tpl'),
        os.path.join('control', 'timg', '071.tpl'),
        os.path.join('control', 'timg', '072.tpl'),
        os.path.join('control', 'timg', '073.tpl'),
        os.path.join('control', 'timg', '075.tpl'),
        os.path.join('control', 'timg', '080.tpl'),
        os.path.join('control', 'timg', '081.tpl'),
        os.path.join('control', 'timg', '084.tpl'),
        os.path.join('control', 'timg', '085.tpl'),
        os.path.join('control', 'timg', '086.tpl'),
        os.path.join('control', 'timg', '087.tpl'),
        os.path.join('control', 'timg', '089.tpl'),
        os.path.join('control', 'timg', '090.tpl'),
        os.path.join('control', 'timg', '091.tpl'),
        os.path.join('control', 'timg', '092.tpl'),
        os.path.join('control', 'timg', '093.tpl'),
        os.path.join('control', 'timg', '097.tpl'),
        os.path.join('control', 'timg', '099.tpl'),
        os.path.join('control', 'timg', '100.tpl'),
        os.path.join('control', 'timg', '101.tpl'),
        os.path.join('control', 'timg', '102.tpl'),
        os.path.join('control', 'timg', '103.tpl'),
        os.path.join('control', 'timg', '104.tpl'),
        os.path.join('control', 'timg', '106.tpl'),
        os.path.join('control', 'timg', '109.tpl'),
        os.path.join('control', 'timg', '111.tpl'),
        os.path.join('control', 'timg', '112.tpl'),
        os.path.join('control', 'timg', '113.tpl'),
        os.path.join('control', 'timg', '114.tpl'),
        os.path.join('control', 'timg', '115.tpl'),
        os.path.join('control', 'timg', '116.tpl'),
        os.path.join('control', 'timg', '117.tpl'),
        os.path.join('control', 'timg', '118.tpl'),
        os.path.join('control', 'timg', '119.tpl'),
        os.path.join('control', 'timg', '120.tpl'),
        os.path.join('control', 'timg', '121.tpl'),
        os.path.join('control', 'timg', '122.tpl'),
        os.path.join('control', 'timg', '123.tpl'),
        os.path.join('control', 'timg', '124.tpl'),
        os.path.join('control', 'timg', '125.tpl'),
        os.path.join('control', 'timg', '126.tpl'),
        os.path.join('control', 'timg', '127.tpl'),
        os.path.join('control', 'timg', '128.tpl'),
        os.path.join('control', 'timg', '129.tpl'),
        os.path.join('control', 'timg', '130.tpl'),
        os.path.join('control', 'timg', '131.tpl'),
        os.path.join('control', 'timg', '132.tpl'),
        os.path.join('control', 'timg', '133.tpl'),
        os.path.join('control', 'timg', '134.tpl'),
        os.path.join('control', 'timg', '135.tpl'),
        os.path.join('control', 'timg', '137.tpl'),
        os.path.join('control', 'timg', '138.tpl'),
        os.path.join('control', 'timg', '139.tpl'),
        os.path.join('control', 'timg', '140.tpl'),
        os.path.join('control', 'timg', '141.tpl'),
        os.path.join('control', 'timg', '142.tpl'),
        os.path.join('control', 'timg', '143.tpl'),
        os.path.join('control', 'timg', '144.tpl'),
        os.path.join('control', 'timg', '145.tpl'),
        os.path.join('control', 'timg', '146.tpl'),
        os.path.join('control', 'timg', '147.tpl'),
        os.path.join('control', 'timg', '148.tpl'),
        os.path.join('control', 'timg', '149.tpl'),
        os.path.join('control', 'timg', '150.tpl'),
        os.path.join('control', 'timg', '151.tpl'),
        os.path.join('control', 'timg', '152.tpl'),
        os.path.join('control', 'timg', '153.tpl'),
        os.path.join('control', 'timg', '154.tpl'),
        os.path.join('control', 'timg', '155.tpl'),
        os.path.join('control', 'timg', '156.tpl'),
        os.path.join('control', 'timg', '157.tpl'),
        os.path.join('control', 'timg', '158.tpl'),
        os.path.join('control', 'timg', '159.tpl'),
        os.path.join('control', 'timg', '160.tpl'),
        os.path.join('control', 'timg', '161.tpl'),
        os.path.join('control', 'timg', '162.tpl'),
        os.path.join('control', 'timg', '163.tpl'),
        os.path.join('control', 'timg', '164.tpl'),
        os.path.join('control', 'timg', '165.tpl'),
        os.path.join('control', 'timg', '166.tpl'),
        os.path.join('control', 'timg', '167.tpl'),
        os.path.join('control', 'timg', '168.tpl'),
        os.path.join('control', 'timg', '169.tpl'),
        os.path.join('control', 'timg', '170.tpl'),
        os.path.join('control', 'timg', '171.tpl'),
        os.path.join('control', 'timg', '172.tpl'),
        os.path.join('control', 'timg', '173.tpl'),
        os.path.join('control', 'timg', '174.tpl'),
        os.path.join('control', 'timg', '175.tpl'),
        os.path.join('control', 'timg', '176.tpl'),
        os.path.join('control', 'timg', '177.tpl'),
        os.path.join('control', 'timg', '178.tpl'),
        os.path.join('control', 'timg', '179.tpl'),
        os.path.join('control', 'timg', '180.tpl'),
        os.path.join('control', 'timg', '181.tpl'),
        os.path.join('control', 'timg', '182.tpl'),
        os.path.join('control', 'timg', '183.tpl'),
        os.path.join('control', 'timg', '184.tpl'),
        os.path.join('control', 'timg', '185.tpl'),
        os.path.join('control', 'timg', '186.tpl'),
        os.path.join('control', 'timg', '187.tpl'),
        os.path.join('control', 'timg', '188.tpl'),
        os.path.join('control', 'timg', '189.tpl'),
        os.path.join('control', 'timg', '190.tpl'),
        os.path.join('control', 'timg', '191.tpl'),
        os.path.join('control', 'timg', '192.tpl'),
        os.path.join('control', 'timg', '193.tpl'),
        os.path.join('control', 'timg', '194.tpl'),
        os.path.join('control', 'timg', '195.tpl'),
        os.path.join('control', 'timg', '196.tpl'),
        os.path.join('control', 'timg', '197.tpl'),
        os.path.join('control', 'timg', '198.tpl'),
        os.path.join('control', 'timg', '199.tpl'),
        os.path.join('control', 'timg', '200.tpl'),
        os.path.join('control', 'timg', '201.tpl'),
        os.path.join('control', 'timg', '202.tpl'),
        os.path.join('control', 'timg', '203.tpl'),
        os.path.join('control', 'timg', '204.tpl'),
        os.path.join('control', 'timg', '205.tpl'),
        os.path.join('control', 'timg', '206.tpl'),
        os.path.join('control', 'timg', '207.tpl'),
        os.path.join('control', 'timg', '208.tpl'),
        os.path.join('control', 'timg', '209.tpl'),
        os.path.join('control', 'timg', '210.tpl'),
        os.path.join('control', 'timg', '211.tpl'),
        os.path.join('control', 'timg', '212.tpl'),
        os.path.join('control', 'timg', '213.tpl'),
        os.path.join('control', 'timg', '214.tpl'),
        os.path.join('control', 'timg', '215.tpl'),
        os.path.join('control', 'timg', '216.tpl'),
        os.path.join('control', 'timg', '217.tpl'),
        os.path.join('control', 'timg', '218.tpl'),
        os.path.join('control', 'timg', '219.tpl'),
        os.path.join('control', 'timg', '220.tpl'),
        os.path.join('control', 'timg', '221.tpl'),
        os.path.join('control', 'timg', '222.tpl'),
        os.path.join('control', 'timg', '223.tpl'),
        os.path.join('control', 'timg', '224.tpl'),
        os.path.join('control', 'timg', '225.tpl'),
        os.path.join('control', 'timg', '226.tpl'),
        os.path.join('control', 'timg', '227.tpl'),
        os.path.join('control', 'timg', '228.tpl'),
        os.path.join('control', 'timg', '229.tpl'),
        os.path.join('control', 'timg', '230.tpl'),
        os.path.join('control', 'timg', '231.tpl'),
        os.path.join('control', 'timg', '232.tpl'),
        os.path.join('control', 'timg', '233.tpl'),
        os.path.join('control', 'timg', '234.tpl'),
        os.path.join('control', 'timg', '235.tpl'),
        os.path.join('control', 'timg', '236.tpl'),
        os.path.join('control', 'timg', '237.tpl'),
        os.path.join('control', 'timg', '238.tpl'),
        os.path.join('control', 'timg', '239.tpl'),
        os.path.join('control', 'timg', '240.tpl'),
        os.path.join('control', 'timg', '241.tpl'),
        os.path.join('control', 'timg', '242.tpl'),
        os.path.join('control', 'timg', '243.tpl'),
        os.path.join('control', 'timg', '244.tpl'),
        os.path.join('control', 'timg', '245.tpl'),
        os.path.join('control', 'timg', '246.tpl'),
        os.path.join('control', 'timg', '247.tpl'),
        os.path.join('control', 'timg', '248.tpl'),
        os.path.join('control', 'timg', '249.tpl'),
        os.path.join('control', 'timg', '250.tpl'),
        os.path.join('control', 'timg', '251.tpl'),
        os.path.join('control', 'timg', '252.tpl'),
        os.path.join('control', 'timg', '253.tpl'),
        os.path.join('control', 'timg', '254.tpl'),
    ],
...
code_in_files = {
    'payload': [
        *protobuf_c_files,
        ...
        os.path.join('payload', 'game', 'obj', 'ObjDirector.cc'),
        ...
        os.path.join('payload', 'game', 'race', 'AwardsManager.S'),
        os.path.join('payload', 'game', 'race', 'AwardsManager.cc'),
        ...
        os.path.join('payload', 'game', 'sound', 'util', 'BackgroundMusicManager.cc'),
        ...
        os.path.join('payload', 'game', 'system', 'Mii.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'AwardDemoCongratulations.cc'),
        os.path.join('payload', 'game', 'ui', 'AwardDemoResultItem.cc'),
        os.path.join('payload', 'game', 'ui', 'AwardPage.S'),
        os.path.join('payload', 'game', 'ui', 'AwardPage.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'FriendRoomMessageSelectPage.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'MatchingMessageWindow.cc'),
        os.path.join('payload', 'game', 'ui', 'MenuInputManager.cc'),
        os.path.join('payload', 'game', 'ui', 'MenuModelControl.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'ServicePackToolsPage.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'TeamColors.cc'),
        os.path.join('payload', 'game', 'ui', 'TeamConfirmControl.cc'),
        os.path.join('payload', 'game', 'ui', 'TeamConfirmPage.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRace2DMap.cc'),
        ...
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceNameBalloon.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceRankNum.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceResult.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceResultTeam.cc'),
        os.path.join('payload', 'game', 'ui', 'ctrl', 'CtrlRaceResultTeamPoint.cc'),
        ...
        os.path.join('payload', 'nw4r', 'snd', 'SoundArchiveLoader.S'),
        ...
        os.path.join('payload', 'revolution', 'mem', 'expHeap.c'),
        os.path.join('payload', 'revolution', 'mem', 'frameHeap.c'),
        os.path.join('payload', 'revolution', 'mem', 'heapCommon.c'),
        os.path.join('payload', 'revolution', 'mem', 'unitHeap.c'),
        ...
        os.path.join('payload', 'sp', 'Host.cc'),
        os.path.join('payload', 'sp', 'IOSDolphin.cc'),
        ...
        os.path.join('payload', 'sp', 'net', 'AsyncListener.cc'),
